...
modules = [
    ...
    'pyfr.solvers.linearadvec',
    'pyfr.solvers.linearadvec.kernels',
    'pyfr.solvers.linearadvec.kernels.bcs',
    'pyfr.solvers.linearadvec.kernels.rsolvers',
...
package_data = {
    ...
    'pyfr.solvers.linearadvec.kernels': ['*.mako'],
    'pyfr.solvers.linearadvec.kernels.bcs': ['*.mako'],
    'pyfr.solvers.linearadvec.kernels.rsolvers': ['*.mako'],
