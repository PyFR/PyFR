             ...
             ${dtype} fout[3][5], ${dtype} gamma, ${dtype} mu, ${dtype} pr)
{
    ...
    ${dtype} u_x = rcprho*(grad_uin[0][1] - u*rho_x);
    ${dtype} u_y = rcprho*(grad_uin[1][1] - u*rho_y);
    ${dtype} u_z = rcprho*(grad_uin[2][1] - u*rho_z);
    ${dtype} v_x = rcprho*(grad_uin[0][2] - v*rho_x);
    ${dtype} v_y = rcprho*(grad_uin[1][2] - v*rho_y);
    ${dtype} v_z = rcprho*(grad_uin[2][2] - v*rho_z);
    ${dtype} w_x = rcprho*(grad_uin[0][3] - w*rho_x);
    ${dtype} w_y = rcprho*(grad_uin[1][3] - w*rho_y);
    ${dtype} w_z = rcprho*(grad_uin[2][3] - w*rho_z);
