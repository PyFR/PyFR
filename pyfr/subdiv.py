...
class BaseSubDiv:
    ...
    @property
    def subcells(self):
        return [self.name]*(self.n**self.ndims)
...
class TensorProdSubDiv(BaseSubDiv):
    ...
    def subnodes(self):
        ...
        nodeoff = np.zeros((self.n,)*self.ndims, dtype=np.int32)
        for dim, off in enumerate(np.ix_(*(range(self.n),)*self.ndims)):
            nodeoff += off*(self.n + 1)**dim

        # Tile standard element node ordering mapping, then apply offsets
        internal_con = np.tile(conbase, (self.n**self.ndims, 1))
...
class QuadSubDiv(TensorProdSubDiv):
    ...
    vtk_nodemaps = {
        ...
        25: [0, 4, 24, 20, 1, 2, 3, 9, 14, 19, 21, 22, 23, 5, 10, 15,
             6, 7, 8, 11, 12, 13, 16, 17, 18],
        36: [0, 5, 35, 30, 1, 2, 3, 4, 11, 17, 23, 29, 31, 32, 33,
             34, 6, 12, 18, 24, 7, 8, 9, 10, 13, 14, 15, 16, 19, 20,
             21, 22, 25, 26, 27, 28],
        49: [0, 6, 48, 42, 1, 2, 3, 4, 5, 13, 20, 27, 34, 41, 43, 44,
...
class TriSubDiv(BaseSubDiv):
    ...
    vtk_nodemaps = {
        ...
        15: [14, 0, 4, 12, 9, 5, 1, 2, 3, 8, 11, 13, 10, 6, 7],
        21: [20, 0, 5, 18, 15, 11, 6, 1, 2, 3, 4, 10, 14, 17, 19, 16,
             7, 9, 12, 8, 13],
        28: [27, 0, 6, 25, 22, 18, 13, 7, 1, 2, 3, 4, 5, 12, 17, 21,
             24, 26, 23, 8, 11, 19, 14, 9, 10, 16, 20, 15],
        36: [35, 0, 7, 33, 30, 26, 21, 15, 8, 1, 2, 3, 4, 5, 6, 14,
             20, 25, 29, 32, 34, 31, 9, 13, 27, 22, 16, 10, 11, 12,
             19, 24, 28, 23, 17, 18],
        45: [44, 0, 8, 42, 39, 35, 30, 24, 17, 9, 1, 2, 3, 4, 5, 6, 7,
...
class TetSubDiv(BaseSubDiv):
    ...
    vtk_nodemaps = {
        ...
        20: [19, 0, 3, 9, 16, 10, 1, 2, 12, 17, 18, 15, 4, 7, 6, 8,
             13, 5, 14, 11],
        35: [34, 0, 4, 14, 31, 25, 15, 1, 2, 3, 18, 27, 32, 33, 30,
             24, 5, 9, 12, 8, 11, 13, 28, 19, 22, 7, 10, 6, 29, 23,
             21, 26, 17, 16, 20],
        56: [55, 0, 5, 20, 52, 46, 36, 21, 1, 2, 3, 4, 25, 39, 48,
...
class PriSubDiv(BaseSubDiv):
    ...
    vtk_nodemaps = {
        ...
        18: [0, 2, 5, 12, 14, 17, 1, 4, 3, 13, 16, 15, 6, 8, 11, 7,
             10, 9],
        40: [0, 3, 9, 30, 33, 39, 1, 2, 6, 8, 7, 4, 31, 32, 36, 38,
...
class PyrSubDiv(BaseSubDiv):
    ...
    def subnodes(self):
        ...
        # the tetrahedra that fill the gaps between successive pyramids
