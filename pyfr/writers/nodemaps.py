...
class VTK8NodeMaps(object):
    """Mappings between the node ordering of PyFR and that of VTK
    Lagrange cells

    Node mappings are contained within two dictionaries; one maps from
    VTK node ordering to PyFR, and the other provides the inverse.
    ...
    from_pyfr = {
        ...
        ('quad', 36): np.array([0,  5, 35, 30,  1,
                                ...
                                21, 22, 25, 26, 27,
                                28]),
        ('hex', 8): np.array([0, 1, 3, 2, 4, 5,
                              7, 6]),
        ('hex', 27): np.array([0,  2,  8,  6, 18,
                               20, 26, 24,  1,  5,
                               7,  3, 19, 23, 25,
                               21,  9, 11, 15, 17,
                               12, 14, 10, 16,  4,
                               22, 13]),
        ('hex', 64): np.array([0,  3, 15, 12, 48,
                               51, 63, 60,  1,  2,
                               7, 11, 13, 14,  4,
                               8, 49, 50, 55, 59,
                               61, 62, 52, 56, 16,
        ...
        ('tri', 10): np.array([9, 0, 3, 7, 4, 1,
                               2, 6, 8, 5]),
        ('tri', 15): np.array([14,  0,  4, 12,  9,
                               5,  1,  2,  3,  8,
                               11, 13, 10,  6,  7]),
        ('tri', 21): np.array([20,  0,  5, 18, 15,
                               11,  6,  1,  2,  3,
                               4, 10, 14, 17, 19,
                               16,  7,  9, 12,  8,
                               13]),
        ('tet', 4): np.array([3, 0, 1, 2]),
        ('tet', 10): np.array([9, 0, 2, 5, 6, 1,
                               7, 8, 3, 4]),
        ('tet', 20): np.array([19,  0,  3,  9, 16,
                               10,  1,  2, 12, 17,
                               18, 15,  4,  7,  6,
                               8, 13,  5, 14, 11]),
        ('tet', 35): np.array([34,  0,  4, 14, 31,
                               25, 15,  1,  2,  3,
                               18, 27, 32, 33, 30,
                               24,  5,  9, 12,  8,
                               11, 13, 28, 19, 22,
        ...
        ('pri', 18): np.array([0,  2,  5, 12, 14,
                               17,  1,  4,  3, 13,
                               16, 15,  6,  8, 11,
                               7, 10,  9]),
        ('pri', 40): np.array([0,  3,  9, 30, 33,
                               39,  1,  2,  6,  8,
                               7,  4, 31, 32, 36,
                               38, 37, 34, 10, 20,
                               13, 23, 19, 29,  5,
