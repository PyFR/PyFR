...
class LinearAdvecElements(BaseFluidElements, BaseAdvectionElements):
    def set_backend(self, *args, **kwargs):
        super().set_backend(*args, **kwargs)

        # Register our flux kernels
        self._be.pointwise.register('pyfr.solvers.linearadvec.kernels.tflux')
        self._be.pointwise.register('pyfr.solvers.linearadvec.kernels.tfluxlin')
